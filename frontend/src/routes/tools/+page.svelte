...
<svelte:head>
  <title>Accessibility Testing Tool - Accessify</title>
</svelte:head>
...
<div class="min-h-screen flex flex-col bg-gray-50 text-gray-900">
  ...
  <header class="border-b bg-white">
    <div class="mx-auto w-full max-w-5xl px-4 py-4 text-center">
      <h1 class="text-2xl font-bold">Accessibility Testing Tool</h1>
      <h6 class="text-lg text-gray-600">Test any website for accessibility issues</h6>
